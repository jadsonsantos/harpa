export const data = [
  ...
  {
    title:
      'Guia bilíngue disponível 24 horas, sem sufoco e sem perrengue chique',
    description: [
      'Assessoria de viagem, antes e durante, com acompanhamento na compra de roupas, busca de tarifas aéreas, além de dicas e sugestões sobre bagagem.'
    ]
  },
  {
    title:
